  ...
  generateForm(product?: Product) {
    ...
    result.subscribe((result) => {
      ...
      this.fields = [
        ...
        {label: 'Ordering', type: 'number', bootstrapGridClass: "col-lg-6" , name: "ordering",  info_check : "Number use to sort the items in a menu listing e.g item with 0 ordering will appear before an item with ordering 1. ", value: product ? product.ordering : null}, 
        {
