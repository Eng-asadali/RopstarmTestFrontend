...
@Component({
  selector: 'app-inventory-vendor',
  templateUrl: './inventory-vendor.component.html',
  styleUrls: ['./inventory-vendor.component.css']
})
export class InventoryVendorComponent implements OnInit {
  @ViewChild(MatPaginator) paginator: MatPaginator;
  dataSource = new MatTableDataSource<any>([]);
  loaded = true;
  data;
  table_headers: any = [];
  constructor(private inventoryService: InventoryVendorService,private router: Router,
